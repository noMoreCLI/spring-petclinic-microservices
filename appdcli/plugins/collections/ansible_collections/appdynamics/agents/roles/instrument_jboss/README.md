...
- instrumentation of Jboss/Wildfly with automatic naming for tier and node names
  (if tier_name is not specified, it can be automatically derived)
  ...
  tasks:
    ...
    - include_role:
      ...
      vars:
        ...
        # tier_name is optional;  if it's not provided, it can be automatically derived
        tier_name: "Jboss"
